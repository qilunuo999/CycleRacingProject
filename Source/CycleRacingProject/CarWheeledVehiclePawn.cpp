...
const FName ACarWheeledVehiclePawn::LookUpBinding("LookUp");
const FName ACarWheeledVehiclePawn::LookRightBinding("LookRight");
const FName ACarWheeledVehiclePawn::EngineAudioRPM("RPM");
...
void ACarWheeledVehiclePawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ACarWheeledVehiclePawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ACarWheeledVehiclePawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ACarWheeledVehiclePawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ACarWheeledVehiclePawn::OnHandbrakeRelease);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ACarWheeledVehiclePawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACarWheeledVehiclePawn::OnResetVR);
}
...
void ACarWheeledVehiclePawn::OnHandbrakeRelease()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ACarWheeledVehiclePawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ACarWheeledVehiclePawn::EnableIncarView(const bool bState)
{
...
void ACarWheeledVehiclePawn::Tick(float DeltaTime)
{
...
void ACarWheeledVehiclePawn::UpdateHUDStrings()
{
...
void ACarWheeledVehiclePawn::SetupInCarHUD()
{
...
void ACarWheeledVehiclePawn::UpdatePhysicsMaterial()
{
